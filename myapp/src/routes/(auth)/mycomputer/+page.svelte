	...
	onMount(async () => {
		...
		let interval = setInterval(() => {
			if (window.finishload) {
				...
				interactive('element0', { minZone: document.querySelector('.minfieldxp') });
			}
		}, 100);
	});
</script>
...
<div
	id="element0"
	class="winxptab window bg-info"
	style="width:600px;height:auto;padding-bottom:35px;"
>
	<div class="content window-body">
		<menu role="tablist">

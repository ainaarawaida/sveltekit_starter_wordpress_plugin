	...
	<div class="main-header-right row m-0">
		...
		<div class="nav-right col pull-right right-menu p-0">
			<ul class="nav-menus">
				...
				<li class="onhover-dropdown">
					<div class="notification-box"><i data-feather="bell" /><span class="dot-animated" /></div>
					...
					<ul class="chat-dropdown onhover-show-div">
						<li>
							<div class="media">
								<img
									...
									src="{assets}/assets/images/user/4.jpg"
									alt=""
								/>
								<div class="media-body">
						...
						<li>
							<div class="media">
								<img
									class="img-fluid rounded-circle me-3"
									src="{assets}/assets/images/user/1.jpg"
									alt=""
								/>
								<div class="media-body">
						...
						<li>
							<div class="media">
								<img
									class="img-fluid rounded-circle me-3"
									src="{assets}/assets/images/user/2.jpg"
									alt=""
								/>
								<div class="media-body">
